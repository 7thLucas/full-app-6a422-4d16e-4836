...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "loginHeadline",
      type: "string",
      required: false,
      label: "Login Headline",
    },
    {
      fieldName: "loginSubtext",
      type: "string",
      required: false,
      label: "Login Subtext",
    },
    {
      fieldName: "compliantThreshold",
      type: "number",
      required: false,
      label: "Compliant Threshold (min score %)",
      min: 0,
      max: 100,
    },
    {
      fieldName: "atRiskThreshold",
      type: "number",
      required: false,
      label: "At-Risk Threshold (min score %)",
      min: 0,
      max: 100,
    },
    {
